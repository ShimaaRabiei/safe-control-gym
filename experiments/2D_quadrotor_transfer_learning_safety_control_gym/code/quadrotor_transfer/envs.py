...
class ReducedQuadrotor2DNavigationEnv(gym.Env):
    ...
    def step(self, action: np.ndarray) -> Tuple[np.ndarray, float, bool, bool, Dict[str, Any]]:
        ...
        penalty_term = float(self.cfg.lambda_penalty) * variation_cost
        train_reward = task_reward - penalty_term
        reward_identity_error = train_reward - (task_reward - penalty_term)
        ...
        info = {
            ...
            "lambda_penalty": float(self.cfg.lambda_penalty),
            "reward_identity_error": float(reward_identity_error),
